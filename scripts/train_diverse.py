"""DIVERSE Dataset ile Training - Görev 3"""
...
def train_diverse():
    ...
    print("=" * 60)
    print("DIVERSE Dataset Training")
    print("=" * 60)
    ...
    # 3. Dataset yükle
    print("\n3. DIVERSE dataset yükleniyor...")
    dataset_loader = DatasetLoader(
        dataset_name="diverse",
        tokenizer=tokenizer,
    ...
    output_dir = "./checkpoints/diverse"
    ...
    print("\n" + "=" * 60)
    print("DIVERSE Training tamamlandı!")
    print("=" * 60)
